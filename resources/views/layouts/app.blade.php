...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="transparent-header no-sticky">
			...
			<div id="header-wrap">
				<div class="container">
					<a href="demo-photography.html"><img src="{{ asset('images/myMarLogo.png') }}" alt="Canvas Logo" height="100"></a>
				</div>
				{{-- <div>
		...
		{{-- <section id="slider" class="slider-element full-screen clearfix" style="background: url({{ asset('images/dots-1.png') }}) 100% 0px / 60% no-repeat; height: 100px;"> --}}

			{{-- full-screen  --}}
			{{-- style="height: 400px;margin-top: 50px;margin-bottom: -150px;" --}}
